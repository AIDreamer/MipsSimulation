...
`define SIZE_WORD  2'h2
   ...
   // Immediate Extend control signal
`define ZeroExImm 2'b00
`define ZeroExUpImm 2'b01
`define SignExImm 2'b10
   
// Comparer module control signal
`define Compare_NULL 3'b000
`define Compare_BEQ 3'b001
`define Compare_BNE 3'b010
`define Compare_BLTZ 3'b011
`define Compare_BGTZ 3'b100

//DEBUG/STATS Print Controls
`define DEBUG_PRINT 1'b0
`define STATS_PRINT 1'b0
